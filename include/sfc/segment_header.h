...
/// @brief Pure parse/serialize for the split-transport Segment Header (P2, Section 13.1, 16 bytes).
///
/// Layout:
...
/// Parsed Segment Header for split-transport files (P2, Section 13.1).
